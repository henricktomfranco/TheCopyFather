...
export function DetectTextType(arg1:string):Promise<rewriter.TextTypeDetected>;
...
export function GetStyleInfo(arg1:string):Promise<rewriter.StyleInfoData|boolean>;

export function GetTextTypes():Promise<Array<rewriter.TextTypeInfo>>;
